		...
		<div class="main-panel">
			<div class="content">
				<div class="page-inner">
					<h4 class="page-title">대출 해지 상품</h4>
					<div class="row">
						<div class="col">
							<div class="card">
								<div class="card-header">
									<div class="card-title">대출 해지 내역 조회</div>
								</div>
								<div class="card-body">
									<sec:csrfInput/>
									<table class="table table-hover card-table">
										<thead>
											<tr>
												...
												<th scope="col">은행</th>  
												<th scope="col">상품 해지일</th>   
												<th scope="col">중도상환해약금</th>
												<th scope="col">상환 여부</th>
												<th scope="col"></th>
											</tr>
										</thead>
										<tbody>
											<tr>
												...
												<td>.</td>
												<td>.</td>
												<td><button class="btn btn-primary btn-xs" onclick="window.location='loanCancelDetail.do'">상세</button></td>
											</tr>
											<tr>
												<td>.</td>
												<td>.</td>
