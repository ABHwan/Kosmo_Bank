...
public class CustomerDAOImpl implements CustomerDAO {
	...
	public AccountVO selectAccount(String account_id) {
		return sqlSession.getMapper(CustomerDAO.class).selectAccount(account_id);
	}
	...
	public List<UtilityVO> apt_mtList(UtilityVO vo) {
		return sqlSession.getMapper(CustomerDAO.class).apt_mtList(vo);
	}

	// 아파트 관리비 납부
	@Override
	public int payApt(Map<String, Object> map) {
		return sqlSession.getMapper(CustomerDAO.class).payApt(map);
	}

	// 회원 등록금
	@Override
	public List<UtilityVO> tuitionList(UtilityVO vo) {
		return sqlSession.getMapper(CustomerDAO.class).tuitionList(vo);
	}

	// 등록금 납부
	@Override
	public int payTuition(Map<String, Object> map) {
		return sqlSession.getMapper(CustomerDAO.class).payTuition(map);
	}

	// 회원 지방세
	@Override
	public List<UtilityVO> localList(UtilityVO vo) {
		return sqlSession.getMapper(CustomerDAO.class).localList(vo);
	}

	// 지방세 납부
	@Override
	public int payLocal(Map<String, Object> map) {
		return sqlSession.getMapper(CustomerDAO.class).payLocal(map);
	}

	// 공과금 납부 처리
	@Override
	public int getUtilityConfirm(UtilityVO vo) {
		return sqlSession.getMapper(CustomerDAO.class).getUtilityConfirm(vo);
	}

	// 회원 계좌 잔액, 공과금 비용 비교
	@Override
	public int compareMoney(Map<String, Object> map) {
		return sqlSession.getMapper(CustomerDAO.class).compareMoney(map);
	}

	// 공과금 겟수
	@Override
	public int getUtilityCnt(String member_id) {
		return sqlSession.getMapper(CustomerDAO.class).getUtilityCnt(member_id);
	}

	// 공과금 목록
	@Override
	public List<UtilityVO> getUtilityList(Map<String, Object> map) {
		return sqlSession.getMapper(CustomerDAO.class).getUtilityList(map);
	}
