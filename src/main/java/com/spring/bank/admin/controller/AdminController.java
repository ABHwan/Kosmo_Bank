...
public class AdminController {
	 ...
	 * // 스케쥴링 테스트
	 * 
	 * @Scheduled(fixedDelay=60000) public void TestScheduler(){ Date date = new
	 * Date(); SimpleDateFormat format2 = new SimpleDateFormat (
	 * "yyyy년 MM월dd일 HH시mm분ss초");
	 * System.out.println("스케줄링 테스트(600000ms -> 10분마다 테스트) 시간 -> " +
	 * format2.format(date)); }
	 */
