			          ...
			          <input type="hidden" name="deposit_product_name" value="${vo.deposit_product_name}">
			          	<table>
							...
							<tr class="form__row textarea">
								<th>예금설명</th>
								<td>
									<textarea name="deposit_product_explanation" class="deposit_product_explanation" >${vo.deposit_product_explanation}</textarea>
								</td>
							</tr>
							...
							<tr class="form__row textarea">
								<th>유의사항</th>
								<td>
									<textarea name="deposit_product_notice" class="deposit_product_explanation" >${vo.deposit_product_notice}</textarea>
								</td>
							</tr>
