			          	...
			          	<c:if test="${cnt > 0}">
				            <li>
								...
								<c:if test="${startPage > pageBlock}">
									<a href="customerSearch"> [◀◀] </a>
									<a href="customerSearch?pageNum=${startPage - pageBlock}"> [◀] </a>
								</c:if>
				            </li>
				            ...
				            <li>
				              <!-- 블록내의 페이지번호 -->
								<c:forEach var="i" begin="${startPage}" end="${endPage}">
									...
									<c:if test="${i != currentPage}">
										<a href="customerSearch?pageNum=${i}">[${i}]</a>
									</c:if>
								</c:forEach>
				            </li>
				            <li>
								...
								<c:if test="${pageCount > endPage}">
									<a href="customerSearch?pageNum=${startPage + pageBlock}"> [▶] </a>
									<a href="customerSearch?pageNum=${pageCount}"> [▶▶] </a>
								</c:if>
							</li>
