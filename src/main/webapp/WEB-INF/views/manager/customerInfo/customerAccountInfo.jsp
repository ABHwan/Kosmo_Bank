			          	...
			          	<c:if test="${cnt > 0}">
				            <li>
								...
								<c:if test="${startPage > pageBlock}">
									<a href="customerAccountInfo"> [◀◀] </a>
									<a href="customerAccountInfo?pageNum=${startPage - pageBlock}"> [◀] </a>
								</c:if>
				            </li>
				            ...
				            <li>
				              <!-- 블록내의 페이지번호 -->
								<c:forEach var="i" begin="${startPage}" end="${endPage}">
									...
									<c:if test="${i != currentPage}">
										<a href="customerAccountInfo?pageNum=${i}">[${i}]</a>
									</c:if>
								</c:forEach>
				            </li>
				            <li>
								...
								<c:if test="${pageCount > endPage}">
									<a href="customerAccountInfo?pageNum=${startPage + pageBlock}"> [▶] </a>
									<a href="customerAccountInfo?pageNum=${pageCount}"> [▶▶] </a>
								</c:if>
							</li>
