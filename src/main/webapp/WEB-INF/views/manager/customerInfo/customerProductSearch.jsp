			          	...
			          	<c:if test="${cnt > 0}">
				            <li>
								...
								<c:if test="${startPage > pageBlock}">
									<a href="customerProductSearch"> [◀◀] </a>
									<a href="customerProductSearch?pageNum=${startPage - pageBlock}"> [◀] </a>
								</c:if>
				            </li>
				            ...
				            <li>
				              <!-- 블록내의 페이지번호 -->
								<c:forEach var="i" begin="${startPage}" end="${endPage}">
									...
									<c:if test="${i != currentPage}">
										<a href="customerProductSearch?pageNum=${i}">[${i}]</a>
									</c:if>
								</c:forEach>
				            </li>
				            <li>
								...
								<c:if test="${pageCount > endPage}">
									<a href="customerProductSearch?pageNum=${startPage + pageBlock}"> [▶] </a>
									<a href="customerProductSearch?pageNum=${pageCount}"> [▶▶] </a>
								</c:if>
							</li>
