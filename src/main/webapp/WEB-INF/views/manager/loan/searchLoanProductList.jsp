					...
					<div class="row">
						<div class="col">
							<div class="card">
								...
								<div class="card-body"> 
									<form action="loanProductList" method="post" id="loanProductform">
										<sec:csrfInput />
											...
											<tbody>
												<c:forEach var="p" items="${loanProducts}">
													<tr>
														<td>
															${p.loan_product_name} 
															<input type="hidden" name="loan_product_name" value="${p.loan_product_name}" />
														</td>
														<td>${p.loan_product_rate}&nbsp;%</td>
														<td><fmt:formatNumber value="${p.loan_product_minPrice}" pattern="#,###.##" />&nbsp;~&nbsp;<fmt:formatNumber value="${p.loan_product_maxPrice}" pattern="#,###.##" />&nbsp;원</td>
														...
														<td><fmt:formatDate value="${p.loan_product_baseDate}" pattern="yyyy-MM-dd" /></td>
														<td><details>
														...
														<td>
															<button id="proRemove" type="button"
											...
											<c:if test="${cnt > 0}">
												...
												<c:if test="${startPage > pageBlock}">
													<li class="page-item"><a class="page-link"
														href="searchLoanProductList.do?pageNum=${startPage - pageBlock}&keyword=${keyword}"
												...
												<c:forEach var="i" begin="${startPage}" end="${endPage}">
													<c:if test="${i == currentPage}">
														<li class="page-item active"><a class="page-link"
															href="searchLoanProductList.do?pageNum=${i}&keyword=${keyword}">${i}</a></li>
													</c:if>
