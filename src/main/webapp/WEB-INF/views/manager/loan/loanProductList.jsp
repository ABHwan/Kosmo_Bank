					...
					<div class="row">
						<div class="col">
							<div class="card">
								...
								<div class="card-body"> 
									<form action="loanProductList" method="post"
										id="loanProductform">
										<sec:csrfInput />
										<table class="table table-hover card-table">
											...
											<tbody>
												<c:forEach var="p" items="${loanProducts}">
													<tr>
														<td>${p.loan_product_name} <input type="hidden"
															name="loan_product_name" value="${p.loan_product_name}" />
														</td>
											...
											<c:if test="${cnt > 0}">
												...
												<c:if test="${startPage > pageBlock}">
													<li class="page-item"><a class="page-link"
														href="loanProductList.do?pageNum=${startPage - pageBlock}"
												...
												<c:forEach var="i" begin="${startPage}" end="${endPage}">
													<c:if test="${i == currentPage}">
														<li class="page-item active"><a class="page-link"
															href="loanProductList.do?pageNum=${i}">${i}</a></li>
													</c:if>
