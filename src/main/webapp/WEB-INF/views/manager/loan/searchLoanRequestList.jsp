					...
					<div class="row">
						<div class="col">
							<div class="card">
								<div class="card-header">
									<div class="card-title">
										<div class="d-flex justify-content-between mt-2">
											대출 가입 내역 조회
											<form action="searchLoanRequestList.do" method="post" name="searchform">
												<sec:csrfInput />
								...
								<div class="card-body"> 
									<form action="loanRequestList" method="post" id="loanRequestform">
										<sec:csrfInput />
											...
											<c:if test="${cnt > 0}">
												...
												<c:if test="${startPage > pageBlock}">
													<li class="page-item"><a class="page-link"
														href="searchLoanRequestList.do?pageNum=${startPage - pageBlock}"
												...
												<c:forEach var="i" begin="${startPage}" end="${endPage}">
													<c:if test="${i == currentPage}">
														<li class="page-item active"><a class="page-link"
															href="searchLoanRequestList.do?pageNum=${i}">${i}</a></li>
													</c:if>
