							...
							<div class="card">
								...
								<div class="card-body">
									<form action="newLoanSignAction.do" name="newLoanSignform" method="post">
					 					<sec:csrfInput />
					 					<input type="hidden" value="${loanProduct.loan_product_bankCode}">
										...
										<!--  -->
											...
											<tr>
												...
												<td><input type="text" value="${loanProduct.loan_product_name}" id="loan_product_name" name="loan_product_name" class="form-control " readonly style="border:none; background-color:transparent !important; height: 40px !important; width: 50%; float: left;" ></td>
											</tr>
											<tr>
												<th class="thCss"><label for="member_id">아이디</label></th>
												<td><input type="text" value="${loanMember.member_id}" id="member_id" name="member_id" class="form-control " readonly style="border:none; background-color:transparent !important; height: 40px !important; width: 50%; float: left;" ></td>
											</tr>
											<tr>
												<th class="thCss"><label for="member_name">이름</label></th>
												<td><input type="text" value="${loanMember.member_name}" id="member_name" name="member_name" class="form-control " readonly style="border:none; background-color:transparent !important; height: 40px !important; width: 50%; float: left;" ></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td style="display:flex;">
													<select class="form-control form-control" name="loan_month" onchange="setEndDate();" style="background-color:transparent !important; height: 40px !important; width: 50%; float: left; align-self: center;">
											...
											<tr>
												...
												<td>
													<select class="form-control form-control" name="loan_repaymentType" style="height: 40px !important; width: 50%; float: left !important;">
											...
											<tr>
												...
												<td><input type="text" id="loan_amount" name="loan_amount" class="form-control " required placeholder="원 단위로 입력하세요." style="background-color:transparent !important; height: 40px !important; width: 50%; float: left;"></td>
											</tr>
											<tr>
												<th class="thCss"><label for="loan_rate">대출금리</label></th>
												<td><input value="${loanProduct.loan_product_rate}" type="text" id="loan_rate" name="loan_rate" class="form-control " readonly style="border:none; background-color:transparent !important; height: 40px !important; width: 50%; float: left;" ></td>
											</tr>
											<tr>
												<th class="thCss"><label for="loan_prepaymentRate">중도상환수수료요율</label></th>
												<td><input type="text" value="${loanProduct.loan_product_prepaymentRate}" id="loan_prepaymentRate" name="loan_prepaymentRate" class="form-control " readonly style="border:none; background-color:transparent !important; height: 40px !important; width: 50%; float: left;" ></td>
											</tr>
											...
											<tr>
												...
												<td style="text-align: left;"><label style="width: 50%;"><input type="text" id="loan_interest" name="loan_interest" class="form-control " readonly style="border:none; background-color:transparent !important; height: 40px !important; float: left;" ></label><label class="text">&nbsp;원</label></td>
											</tr>
											<tr>
