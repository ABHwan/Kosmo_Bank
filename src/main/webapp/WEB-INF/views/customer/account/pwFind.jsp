				...
				<section id="main">
			      <div class="main__container">
			        <div class="main__top">
			          ...
			          <a class="select" href="pwFind.do">비밀번호 찾기</a>
			        </div>
			        <form action="pwFindAction.do" method="post" name="pwFindForm" onsubmit="return pwFind();">
			        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
			        <div class="main__middle">
			          <div class="middle__container">
			            <h2>비밀번호 찾기</h2>
			            <p>
			           	   비밀번호는 이름, 가입한 아이디, 이메일을 통해 찾을 수 있습니다.
			            </p>
