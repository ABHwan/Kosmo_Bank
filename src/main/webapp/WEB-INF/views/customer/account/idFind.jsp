...
<title>아이디 찾기</title>
<!-- CSS -->
<link rel="stylesheet" href="${rePath}css/user/idFind.css" />
<!-- JS -->
			...
			<div class="content">
				...
				<section id="main">
			      <div class="main__container">
			        <div class="main__top">
			          <a class="select" href="idFind.do">아이디 찾기</a>
			          <a href="pwFind.do">비밀번호 찾기</a>
			        </div>
			        <form action="idFindAction.do" method="post" name="idFindForm"  onsubmit="return idFind();">
			        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
			        <div class="main__middle">
			          <div class="middle__container">
			            <h2>아이디 찾기</h2>
			            <p>아이디는 가입시 등록하신 이름, 이메일을 통해 찾을 수 있습니다.</p>
